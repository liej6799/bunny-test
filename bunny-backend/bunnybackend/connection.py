...
from bunnybackend.exceptions import RateLimitException
...
from bunnybackend.backends.redis import ConnectionRedis, TargetRedis
import asyncio
import atexit
...
class HTTPSync(Connection):
    ...
    def write(self, address: str, data=None, json_data=None, headers=None, json=False, text=True, uuid=None):
        ...
        r = requests.post(address, data=data, json=json_data, headers=headers)
